...
export default class SignIn extends Component {
  ...
  render() {
    ...
    const frontFace = (
      <Fragment>
        <img src={FriendlyBud} alt="Slack Cleaner Mascot" />
        <h1 className="SignIn__Title blue">Welcome to the Slack Cleaner!</h1>
        <p className="SignIn__Lead title">
          Delete files from your Slack Workspace!
        </p>
        <p>
          Slack Cleaner uses the Slack API to help you search, manage and
          delete files from your Slack Workspace.
        </p>
        <p>
